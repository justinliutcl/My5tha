...
public class Text4qqtmActivity extends Activity implements View.OnClickListener,OnFooterRefreshListener,
    ...
    public static void launch(Context activity, View transitionView, String resId, String objid, String type, String texttype, String imgsrc) {
        Intent intent = new Intent(activity, Text4qqtmActivity.class);
        ...
        ActivityOptionsCompat options = ActivityOptionsCompat
                .makeSceneTransitionAnimation((Activity) activity, transitionView, "adapter_qqtm_cityimg");
    ...
    public static Text4qqtmActivity instance = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_text4qqtm);
        instance = this;
        loding = new LodingUtil(this);
        imageView = (ImageView) findViewById(R.id.adapter_horgrid_img);
        cityimg = (ImageView) findViewById(R.id.adapter_qqtm_cityimg);
        imageUtil = new ImageUtil(this);
        imgId = getIntent().getStringExtra("resId");
       String cityId =  getIntent().getStringExtra("imgsrc");
        if (!imgId.equals("h5")) {
            imageUtil.displaywithoutanim(cityimg,cityId );
            ViewCompat.setTransitionName(cityimg, "adapter_qqtm_cityimg");
        }
    ...
    private void getJson() {
        HttpConnectionUtil.getGetJson(this, path + "?" + texttype + "=" + objid + "&productType=" + type + "&memberId=" + share.getMemberID(), null, new HttpConnectionUtil.OnJsonCall() {
            ...
            public void JsonCallBack(String str) {
                ...
                setanim();
                setdialog();
                canshuAdapter = new CanshuAdapter(user.getPropertyValueList(), Text4qqtmActivity.this);
                for (DetailItem item : user.getDetail()) {
                    View v = View.inflate(Text4qqtmActivity.this, R.layout.adapter_detial_tuwen, null);
...
//        imageUtil.display(cityimg, user.getFlag());
    ...
    private void setanim() {
        ...
        goodtype.setVisibility(View.VISIBLE);
    ...
    private void go2collect() {
        ...
        HttpConnectionUtil.getJsonJsonwithDialog(this, collectPath, new String[]{"productId", "memberId"}, new String[]{user.getProductId(), share.getMemberID()}, null, new HttpConnectionUtil.OnJsonCall() {
            @Override
            public void JsonCallBack(String str) {
                Toast.makeText(Text4qqtmActivity.this, "收藏成功", Toast.LENGTH_SHORT).show();
                collectimg.setEnabled(flage);
            }
        });
    }
    ...
    private void add2shopcar() {
        ...
        HttpConnectionUtil.getJsonJsonwithDialog(this, add2carPath, new String[]{"productId", "StandardId", "DetailType", "Number", "Belong", "memberId", "EventDetailId", "LimitNum"},
                new String[]{user.getProductId(), user.getStandardId(), user.getDetailType(), i + "", user.getBlongTo(), share.getMemberID(), user.getDetailId(), user.getLimitNumber()}, null, new HttpConnectionUtil.OnJsonCall() {
                    @Override
                    public void JsonCallBack(String str) {
                        Toast.makeText(Text4qqtmActivity.this, "添加成功", Toast.LENGTH_SHORT).show();
                        cartnum += i;
