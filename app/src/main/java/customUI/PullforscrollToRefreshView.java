...
public class PullforscrollToRefreshView extends LinearLayout {
	...
	public PullforscrollToRefreshView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public PullforscrollToRefreshView(Context context) {
		super(context);
		init();
	}
...
//				mPullState = PULL_DOWN_STATE;
	...
	public interface OnHeaderRefreshListener {
		public void onHeaderRefresh(PullforscrollToRefreshView view);
	}
