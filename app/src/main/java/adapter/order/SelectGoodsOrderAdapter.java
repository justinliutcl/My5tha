 ...
 */
public class SelectGoodsOrderAdapter extends BaseAdapter {
    Context context;
    ...
    public SelectGoodsOrderAdapter( List<GoodsorderItem>mlist, Context context, LodingUtil lodingUtil, AddressAdapter.OnadapterChangeCall callback) {
...
//        }
        ...
        List<OrderDetailItem> tlist=mlist.get(position).getOrderDetailViewList();
...
//            holder.showorder.setVisibility(View.VISIBLE);
        ...
        for(final OrderDetailItem orderDetailItem:tlist){
            ...
            attr.setText(orderDetailItem.getStrandardDescription());
    ...
    private void delete(final int position){
        ...
        HttpConnectionUtil.getJsonJsonwithDialog(context, path_delete, new String[]{"MemberId", "Ordernumber"}, new String[]{ShareUtil.getInstanse(context).getMemberID(), mlist.get(position).getOrderNumber()}, lodingUtil, new HttpConnectionUtil.OnJsonCall() {
            @Override
