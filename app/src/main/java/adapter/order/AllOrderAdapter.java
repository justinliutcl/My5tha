...
public class AllOrderAdapter extends BaseAdapter {
    ...
    public AllOrderAdapter(GoodsorderUser user,Context context,LodingUtil lodingUtil,AddressAdapter.OnadapterChangeCall callback) {
...
//        }
        ...
        final List<OrderDetailItem> tlist=user.getList().get(position).getOrderDetailViewList();
        ...
        holder.fastpay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                JumpUtil.jumpWithValue(context, ShouyinActivity.class,
                        new String[]{"money", "CouponIssueId", "title", "position", "id", "initType","incomegwb","incomeyongjin"},
                        new String[]{mlist.get(position).getTotal() + "", "", mlist.get(position).getOrderDetailViewList().get(0).getTitle(), position + "", mlist.get(position).getOrderNumber(), "2",user.getBalance()+"",user.getCommission()+""}, true);
