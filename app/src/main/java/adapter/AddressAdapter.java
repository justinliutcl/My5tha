...
public class AddressAdapter extends BaseAdapter {
    ...
    private void editAddress(int position){
        ...
        JumpUtil.jumpWithValue(context, Addresssave.class,new String[]{"name","phone","zipcode","IdCard","Address","Province","City","Area","AreaCode"},
                new String[]{item.getName(),item.getPhone(),item.getZipcode(),item.getIdCard(),item.getAddress(),item.getProvince(),item.getCity(),item.getArea(),item.getAreaCode()},true);
