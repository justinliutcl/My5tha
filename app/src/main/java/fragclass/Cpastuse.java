 ...
 */
public class Cpastuse extends Fragment implements PullToRefreshView.OnFooterRefreshListener{
    View view;
...
//        loding.showShapeLoding();
        HttpConnectionUtil.getGetJson(getActivity(), path + "?MemberId=" + share.getMemberID(), loding, new HttpConnectionUtil.OnJsonCall() {
            ...
            public void JsonCallBack(String str) {
                user = HttpConnectionUtil.getCouponPastuser(str);
                adapter = new CouponPastuseAdapter(user, getActivity());
    ...
    private void refresh(){
        HttpConnectionUtil.getGetJson(getActivity(), path + "?MemberId=" + share.getMemberID()+"&PageIndex="+now,null, new HttpConnectionUtil.OnJsonCall() {
            @Override
            public void JsonCallBack(String str) {
                CouponPastuser users = HttpConnectionUtil.getCouponPastuser(str);
